         ...
         <div class="panel-body">
           <form action="" method="post">
             <div class="form-group">
               <label for="nama"><h5>User Name</h5></label> <br>
               ...
               <div class="text-center">
                 <input type="submit" name="submit" class="btn btn-primary" value="Login" style="background-color:#2962FF; color:white; width:200px;">
               </div>
             </div>
           </form>
         </div>
