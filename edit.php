   ...
   <div class="row">
     <div class="col-md-6 col-md-offset-3">
       <div class="panel panel-default">
         <div class="panel-heading" style="background-color: #2962FF; color:white;">
           ...
           <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="nip" size="37" readonly value="<?= $nip_detail; ?>"> <br> <br>
             	...
             	<input type="number" class="form-control" name="gaji" min="200000" max="800000" step="50000" style="width: 19em" value="<?= $gaji_detail; ?>"> <br> <br>
              ...
              <label for="departemen">Jabatan</label> <br>
              <select name="departemen" class="form-control">
                <option value="<?= $departemen_detail; ?>">-Jabatan Baru-</option>
              ...
              <div class="text-center" style="margin-top:20px">
                ...
                <input type="submit" class="btn btn-info" name="update" value="Update" style="background-color: #2962FF">
