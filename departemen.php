...
function rupiah($nilai, $pecahan = 0) {
 ...
 <div class="container-fluid" style="margin:50px 10px 50px 10px;">
       ...
       <form method="get">
         <div class="form-group">
           ...
           <select name="filter" onchange="form.submit()" class="form-control">
              <option value="0">-Filter Berdasarkan Jabatan-</option>
              ...
              <option value="Information" <?php if($filter == 'Information'){ echo 'selected'; } ?>>Informasi</option>
   ...
   <div class="row" style="margin-top:50px;">
       <h4 class="text-center">Data Karyawan Viking Persib Merchendise</h4>
   </div>
